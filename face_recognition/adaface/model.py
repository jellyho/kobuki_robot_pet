...
def build_model(model_name='ir_50'):
    if model_name == 'ir_101':
        return iresnet101(input_size=(112, 112))
    elif model_name == 'ir_50':
        return iresnet50(input_size=(112, 112))
    elif model_name == 'ir_se_50':
        return IR_SE_50(input_size=(112, 112))
    elif model_name == 'ir_34':
        return iresnet34(input_size=(112, 112))
    elif model_name == 'ir_18':
        return iresnet18(input_size=(112, 112))
    else:
...
def adaface_inference(model_name, path, device="cuda"):
    if model_name == "r18":
        model = iresnet18(input_size=(112, 112))
    elif model_name == "r34":
        model = iresnet34(input_size=(112, 112))
    elif model_name == "r50":
        model = iresnet50(input_size=(112, 112))
    elif model_name == "r101":
        model = iresnet101(input_size=(112, 112))
    else:
        raise ValueError()
